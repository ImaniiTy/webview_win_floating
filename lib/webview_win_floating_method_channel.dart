...
class MethodChannelWebviewWinFloating extends WebviewWinFloatingPlatform {
  ...
  @override
  Future<void> addCookie(int webviewId, String? name, String? value, String? domain, String? path) async {
    bool? b = await methodChannel
        .invokeMethod<bool?>('addCookie', {"webviewId": webviewId, "name": name, "value": value, "domain": domain, "path": path});
  }
